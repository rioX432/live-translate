...
exports.snapshotMemory = snapshotMemory;
exports.tryGC = tryGC;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, { result: result, ms: ms }];
            }
        });
    });
}
...
function computeStats(values) {
    ...
    var p95Index = Math.min(Math.ceil(sorted.length * 0.95) - 1, sorted.length - 1);
    var p95 = sorted[p95Index];
    var min = sorted[0];
    var max = sorted[sorted.length - 1];
    return { avg: avg, median: median, p95: p95, min: min, max: max };
}
